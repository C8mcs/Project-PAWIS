...
import 'package:pawis_application/registration_page.dart';
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  StreamBuilder<UserPointsModel>(
                      stream: DatabaseService(uid: user.uid).userPointsData,
                      builder: (context, snapshot) {
                        UserPointsModel? userPointsData = snapshot.data;
                        return Text(
                          userPointsData?.points ?? '1',
                          style: TextStyle(
                              fontSize: 24.0,
                              color: Colors.white,
                              fontFamily: 'Inter',
